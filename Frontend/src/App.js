			...
			<table align="center">
				<tbody>
					...
					<tr>
						...
						<td><input id="input_price" type="number" step="0.01" min="0" onKeyPress="return ((event.charCode >= 48 && event.charCode <= 57) ||  event.charCode == 46 || event.charCode == 0); "/></td>
					</tr>
